...
class OpenCodeTaskAdapter:
    name = "opencode"

    def __init__(self) -> None:
        self._legacy = adapter_for("opencode")
    ...
    def spawn(self, task: dict, context_pack: dict, prompt: str) -> SpawnResult:
        ...
        return SpawnResult("opencode", str(task.get("id", "")), str(task.get("agent", "")) or "agent", "dispatch_requested", request)
...
def adapter() -> OpenCodeTaskAdapter:
    return OpenCodeTaskAdapter()
